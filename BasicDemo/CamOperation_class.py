...
class CameraOperation:
    ...
    def Work_thread(self, winHandle):
        ...
        while True:
            ...
            if 0 == ret:
                ...
                print("采集第%d张图像帧: 分辨率(%dx%d)"
                      % (self.st_frame_info.nFrameNum,self.st_frame_info.nWidth, self.st_frame_info.nHeight, ))
                # 释放缓存
    ...
    #     self.buf_lock.release()
    #     return ret
    def Save_jpg(self, full_save_path):
    ...
    # 存BMP图像
    def Save_Bmp(self,full_image_save_path):
        ...
        file_path = full_image_save_path + ".bmp"
        c_file_path = file_path.encode('ascii')
